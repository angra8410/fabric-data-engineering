...
4. **Jurisdictional Comparison & Spatial Mapping:**
   ...
   - **Technical Rationale on Mapping Visuals (Standardizing on Azure Maps / ArcGIS Maps):** Although Power BI's legacy Shape Map visual supports custom TopoJSON polygons, it remains an experimental preview feature without a formal production SLA or General Availability (GA) roadmap. In enterprise and public-sector environments, relying on preview visuals for board-facing cloud PDF exports introduces unnecessary risk of formatting inconsistencies or future deprecation. To ensure long-term stability and full Microsoft enterprise support for official Board packages, we **standardize strictly on Azure Maps or ArcGIS Maps for Power BI**, both of which are fully supported, GA-grade mapping visuals.
...
6. **Mapping Visual Selection (Decided):** Rather than treating Shape Map as a viable alternative, we explicitly adopt **Azure Maps or ArcGIS Maps for Power BI**. Standardizing strictly on General Availability (GA) visuals eliminates preview-feature risks, ensures long-term Microsoft enterprise support, and guarantees high-fidelity cloud rendering for Board-adopted PDF exports.
...
- **Power BI Mapping Standardization:** Updated Section 2.2 and Section 6 to standardize strictly on General Availability (GA) mapping visuals (**Azure Maps / ArcGIS Maps for Power BI**), eliminating preview-feature instability and ensuring long-term Microsoft enterprise support for Board PDF exports.
...
- **Dataverse Capacity Validation Guidance:** Updated Section 3.5 to emphasize pooled tenant database capacity entitlements and instruct direct verification with SCOG's M365 tenant administrator via Power Platform Admin Center. Clarified that SCOG's multi-megabyte growth dataset incurs **$0 in incremental storage add-on fees**, and confirmed Power Apps Premium list pricing at **$20/user/month** for the 1–2 pipeline administrators.
- **Annual Maintenance Operational Ranges:** Reframed the annual maintenance figures in Section 4 as indicative operational planning scenarios (20–40 hrs vs. 2–4 hrs) based on manual coordination vs. automated intake, to be calibrated against SCOG's internal tracking post-Year 1.
